...
class SDBFenRun(models.Model):
    ...
    hardware_point_wx = models.CharField(u"微信硬件费率", choices=HARD_POINT_CHOICE_WX, max_length=50, blank=True)
    point_wx = models.CharField(u"微信代理费率", choices=POINT_CHOICE_WX, max_length=50, blank=True)
